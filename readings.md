...
| Wednesday, 11/13 | Solver-aided systems                           | TBD                  | Emina Torlak and Rastislav Bodik, ["A lightweight symbolic virtual machine for solver-aided host languages" (PLDI 2014)](https://dl.acm.org/citation.cfm?id=2594340) ([off-campus access link (requires CruzID Gold login)](https://dl-acm-org.oca.ucsc.edu/citation.cfm?id=2594340))
| Friday, 11/15    | Solver-aided systems                           | TBD                  | Ali Sinan Köksal, Viktor Kuncak, and Philippe Suter, ["Constraints as control" (POPL 2012)](https://dl.acm.org/citation.cfm?id=2103675) ([off-campus access link (requires CruzID Gold login)](https://dl-acm-org.oca.ucsc.edu/citation.cfm?id=2103675))
| Monday, 11/18    | Solver-aided systems                           | TBD                  | Valter Balegas et al., ["Putting consistency back into eventual consistency" (EuroSys 2015)](https://dl.acm.org/citation.cfm?id=2741972) ([off-campus access link (requires CruzID Gold login)](https://dl-acm-org.oca.ucsc.edu/citation.cfm?id=2741972))
| Wednesday, 11/20 | Domain-specific solvers                        | TBD                  | Guy Katz et al., ["Reluplex: an efficient SMT solver for verifying deep neural networks" (CAV 2017)](https://link.springer.com/chapter/10.1007/978-3-319-63387-9_5) ([extended version on arXiv](https://arxiv.org/pdf/1702.01135.pdf))
| Friday, 11/22    | Domain-specific solvers                        | TBD                  | Guy Katz et al., ["The Marabou framework for verification and analysis of deep neural networks" (CAV 2019)](https://link.springer.com/content/pdf/10.1007%2F978-3-030-25540-4_26.pdf)
...
We'll mostly assume that you are familiar with the basics of **propositional logic**, but if you need a refresher, read [Chapter 1 ("Propositional Logic") of _The Calculus of Computation: Decision Procedures with Applications to Verification_](https://link.springer.com/chapter/10.1007/978-3-540-74113-8_1) by Aaron R. Bradley and Zohar Manna ([off-campus access link (requires CruzID Gold login)](https://link-springer-com.oca.ucsc.edu/chapter/10.1007/978-3-540-74113-8_1)).
...
Many of the solver-aided languages and tools we use rely on the Z3 SMT solver.  The standard citation is: Leonardo de Moura and Nikolaj Bjørner, ["Z3: an efficient SMT solver" (TACAS 2008)](https://link.springer.com/chapter/10.1007/978-3-540-78800-3_24) ([off-campus access link (requires CruzID Gold login)](https://link-springer-com.oca.ucsc.edu/chapter/10.1007/978-3-540-78800-3_24)).  If you want to understand Z3, I suggest working through the [tutorial](https://rise4fun.com/Z3/tutorial/guide).
